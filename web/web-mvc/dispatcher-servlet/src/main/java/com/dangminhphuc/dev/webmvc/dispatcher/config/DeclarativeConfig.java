...
import com.dangminhphuc.dev.webmvc.dispatcher.DeclarativeAnnotationServletInitializerImpl;
...
public class DeclarativeConfig {
    ...
    @Bean
    public ServletInitializer annotationServletInitializer() {
        return new DeclarativeAnnotationServletInitializerImpl();
    }

    @Bean
    public EmbeddedJettyServer embeddedJettyServer() {
        return new EmbeddedJettyServer(0, annotationServletInitializer());
    }
}
